#Trasformate il programma che abbiamo creato in precedenza per la gestione dei voti degli alunni in un
#programma per la gestione di una classe che utilizza un file come database:
#All’avvio il programma chiede se si vuole leggere l’elenco degli alunni e i loro voti e medie, se si vuole aggiungere un
#alunno o un voto, se si vuole eliminare un alunno o un voto 
