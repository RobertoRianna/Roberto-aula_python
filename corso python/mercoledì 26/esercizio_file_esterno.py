...
random_numbers = []                                             #Inizializza una lista vuota per memorizzare i numeri casuali
num_input = 5


while num_input > 0:
    random_number = random.randint(1, 6)                         # Genera un numero intero casuale tra 1 e 6
...
with open("numericasuali.txt","w") as file:                       #crea un file e ci copia sopra i numeri casuali da 1 a 6
